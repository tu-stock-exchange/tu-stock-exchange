<template>
  ...
  <v-container fluid class="bg-black min-h-screen d-flex align-center justify-center">
    ...
    <!-- whole card -->
    <v-card width="420" rounded="xl" elevation="0" class="default-card">

      <v-title class="text-red-400 font-bold" style="font-size: 1.5rem;"> You've gone bankrupt </v-title>

        <div class="box">
          Your net worth dropped below $100, triggering automatic default. All holdings have been liquidated.
        </div>
